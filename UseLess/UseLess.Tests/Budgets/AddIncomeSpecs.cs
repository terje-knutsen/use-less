    ...
    internal class AddIncomeSpecs
    {
        ...
        public class When_add_income_given_budget_is_not_valid : SpecsFor<Budget>
        {
            protected override void InitializeClassUnderTest()
            {
                ...
                SUT.Load(new[] { new Events.IncomeAddedToBudget(It.IsAny<Guid>(),It.IsAny<Guid>(), It.IsAny<decimal>(),IncomeType.Gift.Id, IncomeType.Gift.Name, EntryTime.From(new DateTime(2022,2,2))) });
            }
            [Test]
